<!-- Lesson => [ 31 MySQL - Numeric Functions - Mod, Truncate, Pow {Numeric Function  : Part 2}-->
<!-- This is about studying the [] String Function , as following:  
    *) Testing each function of Numeric functions by practical Example as following   :
        1 - ceil(numericColumn)
        2 - floor(numericColumn)
        3 - round(numericColumn) || round(numericColumn , roundingDecNum) 
-->

<?php
$lesson = '31 MySQL - Numeric Functions - Mod, Truncate, Pow';

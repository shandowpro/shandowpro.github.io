<!-- Lesson => [ 47 MySQL - Simulation Of Join ]  -->
<!-- This is about studying the Organizing operators and Function , as following:  
    *) Testing the simultaing of Join between (2) tables in a dataypes by practical Example as following   :
        1 - { where tbl1.foreignKey =  tbl2.foreignKey } =>  
    -->

<!-- Lesson => [ 28 MySQL - String Functions - Trim, Rtrim, Ltrim {String Function  : Part 7}-->
<!-- This is about studying the [lower , upper] String Function , as following:  
    *) Testing each function of String direction by practical Example as following   :
        1 - Using the single [insert()] string functions for displaying certain inserting value .
        2 - Using the advanced insert => Replacment Inserting [insert()] string function 
        3 - Using the advanced insert => Empty Space Replacment Inserting [insert()] string function 
-->

<?php
$lesson = '28 MySQL - String Functions - Trim, Rtrim, Ltrim';

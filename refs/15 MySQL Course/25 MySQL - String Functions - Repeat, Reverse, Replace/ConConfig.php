<!-- Lesson => [ 25 MySQL - String Functions - Repeat, Reverse, Replace {String Function  : Part 4}-->
<!-- This is about studying the [lower , upper] String Function , as following:  
    *) Testing each function of String direction by practical Example as following   :
        1 - Using the upper(column Name) string function 
        2 - Using the lower(column Name) string function 
        3 - Using the order by [certian Creteria] string function 
        3 - Using the ordering Methods [ASC || DESC] string function 
        
-->

<?php
$lesson = '25 MySQL - String Functions - Repeat, Reverse, Replace';

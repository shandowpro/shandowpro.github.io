<!-- Lesson => [ 17 MySQL - Constraint - Foreign Key Test Relation ]-->

<!-- This is about testing the relationship between more than one tables in the same DB by (2) Methods , as following:  
    a) Testing Tables types :
        1 - Testing an Existing Foreign key Relation of Tables 
        2 - Testing a new Foreign key Relation of Tables  

    b) Testing Procedures  :
        1 - Inserting new records data in the both the parent table and the child   

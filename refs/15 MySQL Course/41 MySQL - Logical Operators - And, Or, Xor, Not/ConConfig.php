<!-- Lesson => [ 41 MySQL - Logical Operators - And, Or, Xor, Not {Logical Opertors  : Part 1} -->
<!-- This is about studying the [Between And Not Between] Comparison Function , as following:  
    *) Testing each Comparison operators with all kinds of dataypes by practical Example as following   :
        1 - { AND } || { && } => And operator : All conditions must be acheived <br> 
        2 - { OR } || { || } => One or Both of conditions must be acheived <br> 
        3 - { ! } || { NOT } => Negative condition <br> 
        4 - { XOR } => Only one condition must be acheived [But not both] <br>   
    -->

<?php
$lesson = '41 MySQL - Logical Operators - And, Or, Xor, Not';

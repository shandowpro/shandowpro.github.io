<!-- Lesson => [ 37 MySQL - Comparison Functions - Between And Not Between {Comparison Function  : Part 1} -->
<!-- This is about studying the [Between And Not Between] Comparison Function , as following:  
    *) Testing each function of Date-Time functions by practical Example as following   :
        1 - { Between Exp1 AND Exp2 }  
        2 - { NOT Between Exp1 AND Exp2 }
-->

<?php
$lesson = '37 MySQL - Comparison Functions - Between And Not Between';

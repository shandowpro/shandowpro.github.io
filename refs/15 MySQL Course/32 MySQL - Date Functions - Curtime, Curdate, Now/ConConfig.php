<!-- Lesson => [ 32 MySQL - Date Functions - Curtime, Curdate, Now {Date Function  : Part 1}-->
<!-- This is about studying the [] String Function , as following:  
    *) Testing each function of Numeric functions by practical Example as following   :
        ...
        2 - curtime() || current_time() || current_time  
        3 - now()     || current_timestamp() || current_timestamp   
-->

<?php
$lesson = '32 MySQL - Date Functions - Curtime, Curdate, Now';

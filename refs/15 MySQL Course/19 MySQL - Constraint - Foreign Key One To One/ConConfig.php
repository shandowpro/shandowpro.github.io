<!-- Lesson => [ 19 MySQL - Constraint - Foreign Key One To One ] {Foreign Key : Part 3}-->

<!-- This is about studying the [One - One] relationship type , as following:  


    *) Testing practical Example on the [one to one] Relatiponship  :
        1 - Creating the Parent Table [clients] 
        2 - Creating the Child Table [cards] 
-->

<?php
$lesson = '19 MySQL - Constraint - Foreign Key One To One';
...
$dsn = 'mysql:host=localhost;dbname=customers';
...
try {
    ...
    $stmt0 = $db->prepare("SELECT * FROM cards JOIN clients ON 'clients.id' = 'cards.clients_id' ");

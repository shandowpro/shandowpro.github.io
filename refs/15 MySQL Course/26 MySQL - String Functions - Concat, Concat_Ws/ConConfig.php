<!-- Lesson => [ 26 MySQL - String Functions - Concat, Concat_Ws {String Function  : Part 4}-->
<!-- This is about studying the [lower , upper] String Function , as following:  
    *) Testing each function of String direction by practical Example as following   :
        1 - Using the single concatentating functions (concat() & concat_ws()) string functions 
        2 - Using the Mixed string functions [concat + other string functions [repeat() & replace() & reverse() ]       
-->

<?php
$lesson = '26 MySQL - String Functions - Concat, Concat_Ws';

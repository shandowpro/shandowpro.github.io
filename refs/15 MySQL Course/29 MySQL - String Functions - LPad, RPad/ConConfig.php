<!-- Lesson => [ 29 MySQL - String Functions - LPad, RPad {String Function  : Part 8}-->
<!-- This is about studying the [padding the string with advancerd filling features] String Function , as following:  
    *) Testing each function of String direction by practical Example as following   :
        1 - Using the Full arguments Rpad(colName , PaddingLength , PaddingMissingString) function .
        2 - Using the Full arguments Lpad(colName , PaddingLength , PaddingMissingString) function .        
-->

<?php
$lesson = '29 MySQL - String Functions - LPad, RPad';

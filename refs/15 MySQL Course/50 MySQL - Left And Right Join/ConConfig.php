<!-- Lesson => [ 50 MySQL - Left And Right Join ]  -->
<!-- This is about studying the merging between tables and it's fields , as following:  
    *) Testing the first type [Left and Right Join] between (2) tables in a dataypes by practical Example as following   :
        1 - {  } =>  
    -->

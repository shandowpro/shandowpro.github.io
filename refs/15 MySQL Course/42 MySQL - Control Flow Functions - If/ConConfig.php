<!-- Lesson => [ 42 MySQL - Control Flow Functions - If {Control Flow functions : Part 1} -->
<!-- This is about studying the [Between And Not Between] Comparison Function , as following:  
    *) Testing each Comparison operators with all kinds of dataypes by practical Example as following   :
        1 - { IF(codition , true statemnt , false statemnt ) } => Control the process flow according to conditon   
    -->

<?php
$lesson = '42 MySQL - Control Flow Functions - If';

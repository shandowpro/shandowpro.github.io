<!-- Lesson => [ 21 MySQL - Constraint - Foreign Key Many To Many ] {Foreign Key : Part 6}-->

<!-- This is about studying the [One - Many] relationship type , as following:  
    *) Testing practical Example on the [one to many] Relatiponship  :
        1 - Creating the Parent Table [clients] 
        2 - Creating the (2) Child Tables [comment] [orders] 
        3 - Using {JOIN} function Testing the relationship between parent table and (2) Child Tables [comment] [orders] 
-->

<?php
$lesson = '21 MySQL - Constraint - Foreign Key Many To Many';
...
$dsn = 'mysql:host=localhost;dbname=relTypes';
...
try {
    ...
    $stmt0 = $db->prepare("SELECT * FROM orders JOIN clients ON 'clients.id' = 'orders.clients_id' ");

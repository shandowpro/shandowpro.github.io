<!-- Lesson => [ 9 MySQL - Tables - Create, Drop, Show Status ]-->
...
/* C] Processing mysql commands of following :  
        1- Inserting multiple new items in the Database [test] -> into table [tbl] -> inside field [(datetime)] by using for variable  
    */
...
try {
    ...
    for ($i = 0, $a = 10, $b = 100, $c = "Text as object", $d = "Chrome", $e = "Edge"; $i <= 100; $i++, $a++, $b++) {

        $stmt1 = $db->prepare(
            "INSERT INTO tbl(strChar, strVarChar, strText, strBlob , strEnum, strSet) VALUES ('" . $i . "' , '" . $a . "' , '" . $b . "' , '" . $c . "' , '" . $d . "' , '" . $e .  "')"
        );

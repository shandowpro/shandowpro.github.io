<!-- Lesson => [ 34 MySQL - Date Functions - Month, Hour, Minute {Date Function  : Part 3}-->
<!-- This is about studying the [] Date-Time Function , as following:  
    *) Testing each function of Date-Time functions by practical Example as following   :
        1 - month() -> To get month Number 
        2 - monthname() -> To get month Name   
        3 - hour() -> To get Hour   
        4 - minute() -> To get Minute   
-->

<?php
$lesson = '34 MySQL - Date Functions - Month, Hour, Minute';

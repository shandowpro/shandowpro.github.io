<!-- Lesson => [ 23 MySQL - String Functions - Length, Char_Length {String Function  : Part 2}-->
<!-- This is about studying the [left , Right , Mid] String Function , as following:  
    *) Testing each function of String direction by practical Example as following   :
        1 - Using the length(column Name) string function 
        2 - Using the char_length(column Name) string function 
        3 - Using the advanced custom naming function [AS ..]     
-->

<?php
$lesson = '23 MySQL - String Functions - Length, Char_Length';

...
function display() {
    ...
    if (z == 1) {
        ...
        let mulDimArr1 = ['shadi', 12, true, false, 'sayed', ['A', 'B', 'C']];
        ...
        let mulDimArr2 = ['shadi', 12, true, false, 'sayed', ['A', 'B', 'C'], [2, 34, 54]];
        ...
        let mulDimArr3 = ['shadi', 12, true, false, 'sayed', ['A', 'B', 'C'], [2, 34, 54], [false, true]];

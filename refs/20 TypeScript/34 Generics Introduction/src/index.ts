...
function display() {
    ...
    if (z == 1) {
        alert(`welcome to Test Define function of returning value of single Datatype using default method `);
        ...
        alert(`welcome to Test Define function of returning value of multiple Datatypes using default method `);
        ...
        alert(`welcome to Test Define function of returning value of Generic Datatype using [Generic Function] by using [default Generic Name]`);
        ...
        alert(`welcome to Test Define function of returning value of Generic Datatype using [Generic Function] by using [Aliase Generic Name] `);

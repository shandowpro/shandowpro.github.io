...
let newUser = new User('shadi');
// C] Executing and printing the object's properties and method  :
console.log(` 
    The value of the defined object's Method using generic Type , with assigned datatype [string] is :
    ${newUser.show('This is the meessage')} 
    The value of the defined object's property using generic Type , with assigned datatype [string] is :
    ${newUser.value}
  `);

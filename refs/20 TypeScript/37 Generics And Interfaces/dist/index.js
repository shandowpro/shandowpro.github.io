...
function display() {
    ...
    if (z == 1) {
        ...
        let item11 = new Collection();
        let item12 = new Collection();
        let item13 = new Collection();
        ...
        let item21 = new Collection();
        let item22 = new Collection();
        let item23 = new Collection();
